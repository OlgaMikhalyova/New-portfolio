# Проекты выполнены в ходе обучения студентом Михалёвой Ольгой в ходе обучения на курсе "Аналитик данных" («Data Analyst») Контактные данные: mixaliovaolga@yandex.ru, 8(962)-875-88-03

1.	Музыка больших городов_ЯндексМузыка (Python, Pandas)
